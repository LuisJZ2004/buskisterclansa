...
# This app
from .views import MovieView, DragMovieStaffView, LikeDislikeView, MovieReviewView, AddReviewView, DeleteReviewView
...
urlpatterns = [
    ...
    path("<slug>/<pk>/reviews/", MovieReviewView.as_view(), name="movie_reviews_path"),
